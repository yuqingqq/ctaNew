...
OUT = REPO/"live/state/convexity/hl_lean175"; OUT.mkdir(parents=True, exist_ok=True)
...
print(f"lean 175-covering preds: flow {nfs} syms/{nfr} rows, price {nps} syms/{npr} rows -> {OUT}")
