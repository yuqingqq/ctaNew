"""Net-test the REMAINING weak-standalone features individually (drop each): autocorr_pctile_7d, resid_rev_3, return_1d.
Residual target, single model both legs. Saved with fold col for the fixed-K fair-fee bot test."""
...
gen([c for c in BASE if c!="autocorr_pctile_7d"],"hl_pv_no_autoc")
gen([c for c in BASE if c!="resid_rev_3"],       "hl_pv_no_rr3")
gen([c for c in BASE if c!="return_1d"],         "hl_pv_no_ret1d")
print("PV2DONE")
