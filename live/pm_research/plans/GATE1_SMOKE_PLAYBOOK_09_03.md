...
**Design:** `p003_de_multiday_gate1_design_v12__20260906T074622Z.json`,
sha256 `c32c72455b26ac3ea5dfa1b3c27bcea2585b72f36f6774d38a05ef5e73923ff5`.
**Parameters:** `live/pm_research/declarations/de_multiday_gate1_params_v5.json`,
sha256 `306bfdb0491afdaded181b0b6777fe4c4a88030e79817881eca076a8452cdc1f`.
...
**Fixture receipt:** `p003_de_multiday_gate1_fixture_run_v11__20260906T074712Z.json`,
sha256 `3064bb46580baadd0e1b04685aedd1183eda3e8a682cd7b1e07b149abb7d2900bb5a424e53f598bfe0538af422b534cd28ccd8dbb73e5b91`.
...
cap (design v12 `R8_time_overrun`; `arm_day()` deadline branch).

**What `--day` holds, and which index splits it needs: NONE.**
Six declared stages (design v12 `R11_memory_and_index_residency`), a
...
All six days run **regardless of interim results** (design v12
...
4. **The draw provenance** — `draw_source == "GENERATED_IN_PROCESS"`,
   ...
   seed reproducible from the book digest and the arm by design v12's
