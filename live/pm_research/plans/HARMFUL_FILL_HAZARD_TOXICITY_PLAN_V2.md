...
**Current status update (2026-09-08T13:18:37Z, direct USER instruction; record update, not a prospective rule change):** NO CLEAN GATE-1 VERDICT. The latest 09-03..09-06 receipts are settlement-P&L point estimates at explicit 250 ms placement latency; they have no replay null, Z, p or day-cluster interval, and 09-03/09-06 each have settlement boundaries outside capture. Directionally, CONDVALUE beats never-cancel on 1/4 design days and HAZARD on 2/4, with four-day raw deltas -25,954.48 / -9,311.59 cents. This does not clear the frozen stopping rule. QR_SKEW_ONLY remains the incumbent; neither cancellation arm is promoted or retuned. The superseding receipts still need independent DA verification, and the append-only register needs a correction to R-832's erroneous CONDVALUE 2/2 win/loss prose.

**Prior status (2026-09-06, USER ruling R-547):** V2 RESUMED. Gate 1's control was the replay null; a minimum five-day run on named days would decide the section 7 stopping rule. The fee blocker was dissolved (maker fee measured zero on-chain and published, R-541/R-537). Design v1 was declared, design v2 was in progress and no data had been touched. The 09-05 status remains below as provenance.
...
> **Sample, as amended by USER rulings R-549(A)/R-550(D)/R-555 (supersedes the line above in band):** admissibility is day-QUALITY on complete days (R-497(F)(1): version is not a bar), and days previously opened for ANY read (08-29 development read; 09-01/09-02 interim read) are NOT untouched. **The set is 2026-09-03, 09-04, 09-05, 09-06, 09-07, 09-08 — G = 6, fixed before any run**, complete at the 2026-09-09T00:06Z verdict; a unanimous pass clears Holm at m = 2.
> **Current sample status, 2026-09-08:** 09-03..09-06 were opened as settlement point estimates and 09-07 was opened diagnostically; all five are consumed. The original six-day set therefore remains design/exploratory evidence and cannot become untouched validation when 09-08 closes. Any validation must prospectively freeze the unchanged policies, replay-null construction, R-801 settlement endpoint, placement-latency sensitivity and multiplicity, then name at least five later untouched complete UTC days before opening them. No seen-day retuning or relabelling is allowed.
...
> **Endpoint status after R-801:** `D_E0` is diagnostic only. The prospective decision metric is settlement P&L (trade cash flow plus residual position settled at each 5-minute close) versus the replay null. Because R-801 and the point-estimate reads came after the design days were seen, they cannot retroactively validate those days.
