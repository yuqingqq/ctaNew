"""FINDING (Q-DA-242): CONDVALUE's 2,875 retained fills are element-wise IDENTICAL to the baseline's -- 0 arm-only keys, 0 fields differing -- so the delta IS the declined fills' value and no path effect contaminates the decomposition.
