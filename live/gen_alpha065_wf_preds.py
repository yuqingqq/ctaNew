...
RR=["resid_rev_2","resid_rev_3"]; ADD=["alpha065"]
...
fac=pd.read_parquet(REPO/"data/ml/cache/alpha191_factors.parquet",columns=["symbol","open_time","alpha065"])
fac["open_time"]=pd.to_datetime(fac["open_time"],utc=True)
PAN=PAN.merge(fac,on=["symbol","open_time"],how="left").dropna(subset=["alpha065"])
...
print("base_lean", gen(V0_LEAN,           D/"hl_a065base_lean/v0full_hl60.parquet"),flush=True)
print("long_lean", gen(V0_LEAN+RR,        D/"hl_a065long_lean/v0full_hl60.parquet"),flush=True)
print("base_a065", gen(V0_LEAN+ADD,       D/"hl_a065base/v0full_hl60.parquet"),flush=True)
print("long_a065", gen(V0_LEAN+ADD+RR,    D/"hl_a065long/v0full_hl60.parquet"),flush=True)
print("GENDONE")
