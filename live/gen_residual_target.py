...
print("res base",gen(V0_LEAN,"z_res",D/"hl_tgt_res_base/v0full_hl60.parquet"),flush=True)
print("res long",gen(V0_LEAN+RR,"z_res",D/"hl_tgt_res_long/v0full_hl60.parquet"),flush=True)
print("GENDONE")
