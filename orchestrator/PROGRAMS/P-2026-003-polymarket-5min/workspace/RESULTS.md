...
| 2026-09-05 | CONDVALUE_X_SKEW | −29,585.13 | −3.47 | 1.000 | −5,855.71 | 6,832.81 | 30,492 / 49,668 | 5,503 | `p003_de_early_read_day_20260905__20260907T112912Z.json` `e8f88dc4…` |
| 2026-09-05 | HAZARD_OVER_SKEWED_REF | +6,540.20 | +4.33 | 0.002 | −397.33 | 1,602.14 | 47,639 / 49,668 | 825 | same |
| 2026-09-06 | CONDVALUE_X_SKEW | −32,132.13 | −5.15 | 1.000 | −5,530.66 | 5,162.01 | 31,206 / 49,568 | 5,940 | `p003_de_early_read_day_20260906__20260907T124731Z.json` `67bce38f…` |
| 2026-09-06 | HAZARD_OVER_SKEWED_REF | −2,111.88 | −1.17 | 0.904 | −621.64 | 1,277.16 | 47,405 / 49,568 | 850 | same |
...
**THE FOUR-DAY READ IS COMPLETE (DA 128, R-798; every value FILLS LEG ONLY, R-795).** Days above the 0-cancel baseline: **CONDVALUE_X_SKEW 0 of 4** (below on 09-03, 09-04, 09-05, 09-06); **HAZARD_OVER_SKEWED_REF 1 of 4** (above on 09-05 only; below on 09-03, 09-04, 09-06). The smallest two-sided sign-test p reachable at G = 4 is 2^-4 = 0.0625 — the design's floor, reachable only by a unanimous sign; no interval below five complete UTC days. The four days are CONSUMED (R-754). **Four day-shapes** (DA 128): 09-03 computed under v15, sealed run RECONSTRUCTED v14, no ledger (key absent), no absolutes; 09-04 computed under v19, sealed run stamped v14, ledger explicit null, no absolutes; 09-05 and 09-06 computed under v19, sealed runs stamped v15, real ledgers, absolutes present. Both v14→v15 (R-764) and v15→v19 (R-794) measured: no estimand, bar or pin key. **Absolutes, 09-06:** 0-cancel baseline **90,153.40 cents**; CONDVALUE arm 58,021.27; HAZARD arm 88,041.52; arm − baseline = the printed D_E0 exactly; DA's recompute 198,611 rows, 0 mismatches. No conclusion is drawn here: the numbers are directional under an exploratory ruling, and the inventory-leg question (R-795) is open with the user.

**Absolutes, 09-05 (the first day with a decision ledger; R-782, R-791, DA 127):** 0-cancel baseline **88,698.17 cents** for the day, summed over its 49,668 fill rows — the fills leg is the whole of it (no separate inventory term in this valuation; an inventory LEG would need an aggregation rule nobody has declared). CONDVALUE arm 59,113.05; HAZARD arm 95,238.37; arm − baseline reconciles to the printed D_E0 exactly for both. DA's independent recompute from the ledger alone (196,898 rows, schema v2, sha `5a2032b5…`): 0 mismatches across D_E0, Z, p, null mean/sd, n draws and both fill counts. 09-05 is the FIRST day on which a cancel arm ended ABOVE the 0-cancel baseline and above the matched random-cancel null (HAZARD, +6,540.20, Z +4.33); CONDVALUE ended below on all three days. Still EXPLORATORY: G 4 consumed, point estimates, no interval; one day's sign is not a result. Label: computed under params v19; the sealed 09-05 run stamped **v15**; the v15→v19 delta measured key-by-key at R-794 (62 added / 10 removed / 9 changed): the two USER-ruling blocks, BE 96's cascade entry (battery-only, no draw-path function or pinned constant moved — REV 93 and DE independently), the ten-module cascade pin block, supersedes/version bookkeeping; design pointer v23 in BOTH; no estimand, bar or pin key.
