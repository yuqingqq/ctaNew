...
_base=["2025-10-04","2025-11-01","2025-12-01","2026-01-01","2026-02-01","2026-03-01","2026-04-01","2026-05-01","2026-05-27"]
_pe=pd.read_parquet(PANEL,columns=["open_time"]); _last=pd.to_datetime(_pe["open_time"],utc=True).max().normalize()+pd.Timedelta(days=1)
CUTS=[pd.Timestamp(t,tz="UTC") for t in _base]+[_last]  # final fold = last base cut -> latest panel date (dynamic)
