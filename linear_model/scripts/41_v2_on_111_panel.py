...
Input panel: 111 symbols from outputs/vBTC_features_btc_only_111_pit/
...
PANEL_111 = REPO / "outputs/vBTC_features_btc_only_111_pit/panel_btc_only_111.parquet"
KLINES_DIR = REPO / "data/ml/test/parquet/klines"
OUT = REPO / "linear_model/results/step41_111panel_pit"
...
def main():
    ...
    print("  STEP 41: V2 on 111-input panel (110 traded after BTC exclusion) + V3.1 sleeve", flush=True)
    print("=" * 100, flush=True)
    t0 = time.time()
