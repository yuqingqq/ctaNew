...
This script:
  ...
  5. Saves all artifacts to results/step50_causal_full_pit/
"""
...
OUT = REPO / "linear_model/results/step50_causal_full_pit"
...
def main():
    ...
    print("  STEP 50: CAUSAL-aligned aggregator rerun on full-PIT V2 110-panel", flush=True)
    print("=" * 100, flush=True)
