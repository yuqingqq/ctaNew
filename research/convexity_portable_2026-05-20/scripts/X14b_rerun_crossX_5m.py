...
def load_panel_with_5m_crossX():
    ...
    cross_path = REPO / "data/ml/cache/cross_exchange_features_5m.parquet"
...
def main():
    ...
    for v_name, desc, fn_key in variants:
        ...
        try:
            ...
            pred_path = CACHE / f"x14b_{v_name}_preds.parquet"
        ...
        m = x6.run_sleeve_on_preds(pred_path, f"x14b_{v_name}")
    ...
    out_csv = OUT / "X14b_crossX_5m_rerun.csv"
